# worker pool: enterprise_1_b_osx_arm64

Changelog for the `enterprise_1_b_osx_arm64` mac worker pool (role + role Hiera), maintained by RelOps Herald. Newest entries first.
