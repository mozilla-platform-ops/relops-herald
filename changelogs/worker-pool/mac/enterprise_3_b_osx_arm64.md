# worker pool: enterprise_3_b_osx_arm64

Changelog for the `enterprise_3_b_osx_arm64` mac worker pool (role + role Hiera), maintained by RelOps Herald. Newest entries first.
