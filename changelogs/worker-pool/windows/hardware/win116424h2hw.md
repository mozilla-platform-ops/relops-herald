# worker pool: win116424h2hw

Changelog for the `win116424h2hw` windows hardware worker pool (role + role Hiera), maintained by RelOps Herald. Newest entries first.
